...
def main():
    ...
    def parser(tokens):
        ...
        parse_table = [["terminals","ident","intConstant","doubleConstant","boolConstant","stringConstant","null","int","double","bool","string","class","void","interface","this","extends","implements","for","while","if","else","return","break","new","NewArray","Print","ReadInteger","ReadLine","true","false",";","&&","||","!",",",".","[","{","(","=","+","-","*","/","%","<",">","<=",">=","==","!=","]","}",")","/epsilon"],
                    ...
                    ["VariableDeclMulti",["VariableDeclMulti","VariableDecl"],"/epsilon","/epsilon","/epsilon","/epsilon","/epsilon",["VariableDeclMulti","VariableDecl"],["VariableDeclMulti","VariableDecl"],["VariableDeclMulti","VariableDecl"],["VariableDeclMulti","VariableDecl"],"/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon",["VariableMulti",","],"/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon","/epsilon"],
                    ...
                    ["Type'","/epsilon",None,None,None,None,None,"/epsilon","/epsilon","/epsilon","/epsilon","/epsilon",None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,["Type'","]","["],None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None],
