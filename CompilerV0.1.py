...
def main():
    ...
    def parser(tokens):
        ...
        parse_table = [["terminals","ident","intConstant","doubleConstant","boolConstant","stringConstant","null","int","double","bool","string","class","void","interface","this","extends","implements","for","while","if","else","return","break","new","NewArray","Print","ReadInteger","ReadLine","true","false",";","&&","||","!",",",".","[","{","(","=","+","-","*","/","%","<",">","<=",">=","==","!=","/epsilon"],
                    ["Program",["DeclMulti","Decl"],None,None,None,None,None,["DeclMulti","Decl"],["DeclMulti","Decl"],["DeclMulti","Decl"],["DeclMulti","Decl"],["DeclMulti","Decl"],["DeclMulti","Decl"],["DeclMulti","Decl"],None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None],
